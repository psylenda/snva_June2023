	...
	public static void main(String[] args) {
		...
		while (run == 1) {
			...
			if (idFound == false) {
				...
				BankApp patron = new BankApp(accountIDs[indexofFoundID], passwords[indexofFoundID], balances[indexofFoundID]);
				System.out.println("Please enter password:");
				String passwordInput = scanner.nextLine();
				if (passwordInput.equals(patron.password)) {
